...
public class BattleFrame extends javax.swing.JFrame {
     ...
     */
    public BattleFrame(AbstractUnit one, AbstractUnit two) {
    ...
    private void initComponents() {
        ...
        logPanelLayout.setHorizontalGroup(
                logPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(logPanelLayout.createSequentialGroup()
                                .addComponent(labelBattleLog, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(38, 38, 38)
        ...
        labelHero1HP.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        ...
        labelHero1Dmg.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        labelHero1Dmg.setText("Урон");

        labelHero1Def.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        ...
        labelHero2HP.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        ...
        labelHero2Dmg.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        labelHero2Dmg.setText("Урон");

        labelHero2Def.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        ...
        hero1HitPerc.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
        ...
        hero2HitPerc.setFont(new java.awt.Font("Noto Sans", 0, 11)); // NOI18N
    ...
    private void btnChangeWeaponActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeWeaponActionPerformed
        ...
        switch (this.ComboBox.getSelectedIndex()) {
            ...
            case 0:
                this.hero1WeaponImage.setIcon(new ImageIcon("src\\Images\\Weapons\\dagger.png"));
                break;
            case 1:
                this.hero1WeaponImage.setIcon(new ImageIcon("src\\Images\\Weapons\\sword.png"));
                break;
            case 2:
                this.hero1WeaponImage.setIcon(new ImageIcon("src\\Images\\Weapons\\longSword.png"));
                break;
            case 3:
                this.hero1WeaponImage.setIcon(new ImageIcon("src\\Images\\Weapons\\axe.png"));
                break;
            case 4:
                this.hero1WeaponImage.setIcon(new ImageIcon("src\\Images\\Weapons\\axeDoubleEdge.png"));
                break;
            default:
...
//        this.labelHero1Name.setText(evt.getKeyCode()+"");
    ...
    public void setHeroesImages(AbstractUnit one, AbstractUnit two) {
    ...
    //Установить все параметры первого персонажа + Статус
    public void setHeroesStats(AbstractUnit one, AbstractUnit two) {
...
//            Thread.sleep(1500);
    ...
    //Фаза эффектов в начале каждого хода
    private void EffectPhase(AbstractUnit unit) {
...
//        }
    ...
    void turn(AbstractUnit attackUnit, AbstractUnit defenceUnit) {

        this.addBattleLog("*** " + turn + " ход ***");
        this.addBattleLog("Атакует: " + attackUnit.BattleInfo());
        ...
        if (!Dmg.isMiss()) {
            ...
            if (Dmg.isCritical()) {
                ...
                if (Dmg.getWeaponDmg() > 0) {
                    ...
                    this.addBattleLog(two.getName() + " получил " + one.getWeapon().getEffect().getName());
    ...
    public void heroWin(AbstractUnit unit) {
